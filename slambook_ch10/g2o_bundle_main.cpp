...
{
    //-----------------------------
    std::unique_ptr<g2o::BlockSolverX::LinearSolverType> linear_solver = g2o::make_unique<g2o::LinearSolverDense<g2o::BlockSolverX::PoseMatrixType>>();
    //std::unique_ptr<g2o::LinearSolver<BalBlockSolver::PoseMatrixType>>linearSolver = g2o::make_unique<g2o::LinearSolver<BalBlockSolver::PoseMatrixType>>();
    std::unique_ptr<g2o::BlockSolverX> block_solver = g2o::make_unique<g2o::BlockSolverX>(std::move(linear_solver));
    //std::unique_ptr<BalBlockSolver> block_solver = g2o::make_unique<BalBlockSolver>(std::move(linear_solver));

    //-----------------------------

    g2o::OptimizationAlgorithmWithHessian* solver;
    if (params.trust_region_strategy == "levenberg_marquardt") {
        solver = new g2o::OptimizationAlgorithmLevenberg(std::move(block_solver));
    }
    else if (params.trust_region_strategy == "dogleg") {
        solver = new g2o::OptimizationAlgorithmDogleg(std::move(block_solver));
    }
    else
    {
