...
void poseEstimationDirect(const vector< Measurement >& measurements, cv::Mat* gray, Eigen::Matrix3f& K, Eigen::Isometry3d& Tcw)
{
    ...
    std::unique_ptr<DirectBlock::LinearSolverType> linear_solver = g2o::make_unique<g2o::LinearSolverDense< DirectBlock::PoseMatrixType >>();
    std::unique_ptr<DirectBlock> solver_ptr = g2o::make_unique<DirectBlock>(std::move(linear_solver));
